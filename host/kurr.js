...
kurr.send5ButImg(m.chat, Anu, ` BOT HOSTING BY KURRXD `, fatihgans, btn)
                                          break
...
if (!isCreator) throw  m.reply(`Lu Siapa Ajg`)
        ...
        axios.get(`https://serverlu:2087/json-api/removeacct?api.version=1&username=${uname}`, { headers: { Authorization: "Basic " + Buffer.from("root:password").toString("base64") } })
